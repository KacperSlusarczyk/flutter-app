...
import 'package:fl_app/ui/common/separator.dart';
import 'package:fl_app/ui/detail/detail_page.dart';
import 'package:fl_app/ui/text_style.dart';
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Container(
                width: horizontal ? 6.0 : 32.0,
              ),
              Expanded(
                  flex: horizontal ? 1 : 0,
                  child: _planetValue(
                    value: planet.distance,
                    image: 'assets/img/ic_grafity.png',
                  )),
            ],
          )
        ],
